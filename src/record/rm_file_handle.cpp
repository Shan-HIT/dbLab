...
Rid RmFileHandle::insert_record(char* buf, Context* context) {
    ...
    int slot_no = Bitmap::first_bit(false, RPH.bitmap, file_hdr_.num_records_per_page);
    Bitmap::set(RPH.bitmap, slot_no);
    ...
    return Rid{RPH.page->get_page_id().page_no, slot_no};
}
...
void RmFileHandle::insert_record(const Rid& rid, char* buf) {
    RmPageHandle RPH = fetch_page_handle(rid.page_no);//先把数据页通过rid->page_no找到
...
RmPageHandle RmFileHandle::create_new_page_handle() {
    ...
    RPH.page_hdr->next_free_page_no = RM_NO_PAGE;
